...
export default function cellphones () {
    ...
    <Sidebar />
    <section className="w-full px-5 py-24 mx-auto max-w-7xl md:w-3/4 lg:w-2/4">
  ...
  <div className="p-5">
    <a href="https://www.att.com/">
        ...
        <a href="https://www.att.com/" className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Explore
  ...
  <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-white-800 dark:border-white-1500">
  <div className="p-5">
    <a href="https://www.boostmobile.com/">
      ...
      <p className="mb-4 text-base font-normal text-gray-600">
        ...
        <a href="https://www.boostmobile.com/" className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Explore
        <svg className="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
        </a>
    </div>
  ...
  <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-white-800 dark:border-white-1500">
  <div className="p-5">
    <a href="https://www.cricketwireless.com/">
        ...
        <a href="https://www.cricketwireless.com/" target="_blank" className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Explore
        <svg className="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
    </a>
    </div>
  ...
  <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-white-800 dark:border-white-1500">
  <div className="p-5">
    <a href="https://sprint.com/apps/makeachoice/index.html">
        <img className="rounded-t-lg" src="https://s3-media0.fl.yelpcdn.com/bphoto/muonXP4Z-5mIpE4tUMtUNQ/258s.jpg" alt="" />
    </a>
   
        <a href="https://sprint.com/apps/makeachoice/index.html">
        <h5 className="mb-7 text-2xl font-bold tracking-tight text-gray-900">Sprint</h5>
        </a>
        <p className="mb-5 text-base font-normal text-gray-600">
       ...
       Gainesville FL 32601
        ...
        <a href="https://sprint.com/apps/makeachoice/index.html" className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Explore
        <svg className="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
         </a>
    </div>
  ...
  <div className="p-5">
    <a href="https://www.t-mobile.com/">
        <img className="rounded-t-lg" src="data:image/png;base64," alt="" />
    </a>
   
        <a href="https://www.t-mobile.com/">
        <h5 className="mb-7 text-2xl font-bold tracking-tight text-gray-900">T-mobile</h5>
        </a>
        <p className="mb-5 text-base font-normal text-gray-600">
        3401 SW Archer Rd.
        Gainesville  FL 32608
       ...
       Gainesville FL 32609
        ...
        <a href="https://www.t-mobile.com/" className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Explore
        <svg className="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
        </a>
    </div>
