...
export default function cellphones () {
  ...
  <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
    ...
    <div className="p-5">
        <a href="#">
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">AT&T</h5>
        </a>
        <p className="mb-4 text-base font-normal text-gray-600 dark:text-white">
        3626 SW Archer Rd.
  ...
  <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
    ...
    <div className="p-5">
        <a href="#">
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Boost Mobile</h5>
        </a>
        <p className="mb-4 text-base font-normal text-gray-600 dark:text-white">
  ...
  <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
    ...
    <div className="p-5">
        <a href="#">
        <h5 className="mb-7 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Cricket Wireless</h5>
        </a>
        <p className="mb-5 text-base font-normal text-gray-600 dark:text-white">
        405 NW 13th St. 
        Gainesville FL 32601
        </p>
        <p className="mb-5 text-base font-normal text-gray-600 dark:text-white">
